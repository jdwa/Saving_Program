	...
	<table id="role">
		...
		<s:iterator value="roleList">
			<tr>
				...
				<security:authorize access="hasAnyRole('ROLE_ADMIN')">
					<td><a href="deleteRole.action?id=<s:property value="id" />"><s:text name="submit.delete" /></a></td>
				</security:authorize>	
				<td><a href="detailRole.action?id=<s:property value="id" />"><s:text name="submit.detail" /></a></td>
			</tr>
		</s:iterator>
	</table>
</body>
