...
<title><s:text name="action.trade.202" /></title>
</head>
<body>
	<h3><s:text name="action.trade.202" /></h3>
	<s:actionerror />
	<s:actionmessage />
	<s:form action="addTrade202" method="post" namespace="/">
		<s:textfield key="trade.tx_no" />
		<s:select key="company.cmp_no" list="companyList" listKey="cmp_no" listValue="cmp_description" />
