...
public class Trade implements Serializable {
	...
	public String getTx_no_widget() {
		return tx_no;
	}
	public void setTx_no_widget(String tx_no_widget) {
		this.tx_no = tx_no_widget;
	}
	...
	public String toString() {
		return "id:" + id + " tx_id:" + tx_no // + " type_id:" + type_id
