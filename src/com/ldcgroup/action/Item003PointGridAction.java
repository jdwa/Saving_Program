...
public class Item003PointGridAction extends ActionSupport implements Preparable, SessionAware, ParameterAware {
	...
	public String execute() {
		...
		Item item = (Item)itemBo.findByNo("003");
