...
public class Type004StatementGridAction extends ActionSupport implements Preparable, SessionAware, ParameterAware {
	...
	public Type004StatementGridAction() {
		super();
	}
	...
	public String execute() {
		...
		Type type = (Type)typeBo.findByNo("004");
