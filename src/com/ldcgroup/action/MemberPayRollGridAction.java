...
public class MemberPayRollGridAction extends ActionSupport implements Preparable, SessionAware, ParameterAware {
	...
	public MemberPayRollGridAction() {
		super();
	}
	...
	public String execute() {
		...
		if (member != null) {
			List<Pay> memberPayList = this.payBo.list(member);
