...
public class Type002StatementGridAction extends ActionSupport implements Preparable, SessionAware, ParameterAware {
	...
	public Type002StatementGridAction() {
		super();
	}
	...
	public String execute() {
		...
		Type type = (Type)typeBo.findByNo("002");
