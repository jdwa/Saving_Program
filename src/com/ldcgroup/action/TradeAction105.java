...
/*
 * Trade Action 105 : 退休提領
 * @author jdwa
 */
public class TradeAction105 extends ActionSupport implements Preparable, SessionAware {
	...
	public String execute() throws Exception {
		...
		String withdrawType = getText("category.105"); // 退休提領
		...
		if (statements.size() > 0) {
			...
			trade.setCategory(getCategoryBo().findByNo("105"));
			...
			this.member.setRole(getRoleBo().findByCode(Definition.ROLE_RETIRE));
