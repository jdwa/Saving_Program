...
/*
 * Trade Action 106 : 晉升提領
 * @author jdwa
 */
public class TradeAction106 extends ActionSupport implements Preparable, SessionAware {
	...
	public String execute() throws Exception {
		...
		String withdrawType = getText("category.106"); // 晉升提領
		...
		if (statements.size() > 0) {
			...
			trade.setCategory(getCategoryBo().findByNo("106"));
			...
			this.member.setRole(getRoleBo().findByCode(Definition.ROLE_PROMOTE));
