...
/*
 * Trade Action 109 : 定額提領（批次）
 * @author jdwa
 */
public class TradeAction109 extends ActionSupport implements Preparable, SessionAware {
	...
	public String execute() throws Exception {
		...
		if (statements.size() > 0) {
			// Add trade data
			this.trade.setFund(type001WithdrawSum + type002WithdrawSum);
			trade.setValid(Boolean.TRUE);
			trade.setCategory(getCategoryBo().findByNo("102")); // Category is the same as "102".
