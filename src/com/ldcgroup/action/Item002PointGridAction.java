...
public class Item002PointGridAction extends ActionSupport implements Preparable, SessionAware, ParameterAware {
	...
	public String execute() {
		...
		Item item = (Item)itemBo.findByNo("002");
