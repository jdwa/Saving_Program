...
/*
 * Trade Action 103 : 職災提領
 * @author jdwa
 */
public class TradeAction103 extends ActionSupport implements Preparable, SessionAware {
	...
	public String execute() throws Exception {
		...
		String withdrawType = getText("category.103"); // 職災提領
		...
		if (statements.size() > 0) {
			...
			trade.setCategory(getCategoryBo().findByNo("103"));
			...
			this.member.setRole(getRoleBo().findByCode(Definition.ROLE_ACCIDENT));
