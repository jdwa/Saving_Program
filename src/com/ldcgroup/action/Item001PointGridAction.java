...
public class Item001PointGridAction extends ActionSupport implements Preparable, SessionAware, ParameterAware {
	...
	public String execute() {
		...
		Item item = (Item)itemBo.findByNo("001");
