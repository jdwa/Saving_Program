...
/*
 * Trade Action 104 : 離職提領
 * @author jdwa
 */
public class TradeAction104 extends ActionSupport implements Preparable, SessionAware {
	...
	public String execute() throws Exception {
		...
		if (!breakloop) {
			...
			String withdrawType = getText("category.104"); // 離職提領
		...
		if ((statements.size() > 0) && (!breakloop)) {
			...
			trade.setCategory(getCategoryBo().findByNo("104"));
			...
			this.member.setRole(getRoleBo().findByCode(Definition.ROLE_RESIGN));
